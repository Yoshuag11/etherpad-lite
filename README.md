...
0. If you have installed mkcert, run `mkcert localhost` to create the key and certificate files to start the application. Otherwise proceed to create them in any way you prefer, making sure to configure them within the project.
